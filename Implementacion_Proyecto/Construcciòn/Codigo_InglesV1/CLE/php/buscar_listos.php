<?php 
	...
	if ($Texto != ""){
		$sql = "SELECT * FROM dispositivos WHERE (id_dispositivo  = '$Texto' OR nombre LIKE '%$Texto%')  AND estatus IN ('Listo (En Taller)','Listo (No Reparado)') AND fecha > '2019-01-01' Limit 20";
	}
