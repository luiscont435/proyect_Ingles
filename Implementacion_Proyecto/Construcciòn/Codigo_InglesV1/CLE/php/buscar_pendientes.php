<?php 
	...
	$sql = "SELECT * FROM dispositivos WHERE estatus IN ('Cotizado','En Proceso','Pendiente')  Limit 50";

	if ($Texto != ""){
		$sql = "SELECT * FROM dispositivos WHERE (id_dispositivo  = '$Texto' OR nombre LIKE '%$Texto%')  AND estatus IN ('Cotizado','En Proceso','Pendiente') Limit 20";
	}
